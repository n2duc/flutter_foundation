                    ...
                    children: [
                      ...
                      BlocSelector<CartCubit, CartState, double>(
                        ...
                        builder: (context, subtotal) {
                          const double bookingFee = 10.0;
                          const double discount = 10.0;
                          final double grandTotal =
                              subtotal + bookingFee - discount;
                          return Column(
                            children: [
                              Row(
                                mainAxisAlignment:
          ...
          child: Container(
            ...
            child: BlocSelector<CartCubit, CartState, double>(
              ...
              builder: (context, subtotal) {
                const double bookingFee = 10.0;
                const double discount = 10.0;
                final double grandTotal = subtotal + bookingFee - discount;
                return Row(
